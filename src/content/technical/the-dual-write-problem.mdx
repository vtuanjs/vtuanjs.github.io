...
<LostEventTimeline
  ...
  label="The order commits to the database, but the published event is silently lost before it reaches the broker — no exception, no log."
/>
  ...
  cards={[
    {
      ...
      note: 'ghost event — you announced an order that never existed, and a downstream service charges a card or reserves stock for a phantom',
    },
    {
  ...
  cards={[
    {
      ...
      text: 'Committed data, a lost event, no error, nothing in the logs to trace it.',
