...
<Pipeline
  title="Hotfix order that must not reverse"
  steps={[
    { label: 'merge fix to develop', note: 'always starts here', tone: 'accent' },
  ...
  caption="Reverse this — fix production first — and the next release from develop silently overwrites the fix."
/>
