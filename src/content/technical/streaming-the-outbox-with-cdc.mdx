...
<FlowChain
  ...
  nodes={[
    { label: 'outbox' },
    { label: 'relay', note: 'SELECT on a timer' },
    { label: 'broker' },
  ]}
/>
...
<FanOut
  source={{ label: 'outbox row', note: 'one insert' }}
  title="EventRouter SMT"
  targets={[
    { label: 'topic', note: 'routed by aggregate_type', tone: 'ok' },
    { label: 'message key', note: 'aggregate_id → same order, same partition', tone: 'ok' },
    { label: 'message body', note: 'the payload you shaped', tone: 'ok' },
    { label: 'headers', note: 'trace id, acting user', tone: 'accent' },
  ]}
/>
